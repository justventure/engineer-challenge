...
6. Не использовал jwt посколько сервис 1 нету экосистемы сервисов(не отсносящихся к web), сессия шариться cross-domain, если cookie-based и делаем запрос с другого домена с credentials: include
